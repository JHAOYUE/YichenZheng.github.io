...
<div class="navbar-header page-scroll"><button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1"><span class="sr-only">Toggle navigation</span> <span class="icon-bar"></span><span class="icon-bar"></span><span class="icon-bar"></span></button>[Microdust](/)</div>
...
<style type="text/css">header.intro-header{ background-image: url('/img/fantasy.jpg') }</style>
...
<div class="Tags">[Tech](/Tags/#Tech "Tech")</div>

# 打造你的 GitHub Pages 专属博客（小白教程）

<span class="meta">Posted by Azeril on October 19, 2015</span></div>
...
*   [← Previous Post](/blog/Selected-Collection-of-Jekyll-Themes.html "Jekyll 博客主题精选")
*   [Next Post →](/blog/Build-A-Hugo-Blog.html "搭建一个 Hugo Blog")

<style>.ds-share{ text-align: right; } @media only screen and (max-width: 700px) { .ds-share { } }</style>

<div class="ds-share" data-thread-key="/blog/Build-Your-First-GitHub-Pages-Blog" data-title="打造你的 GitHub Pages 专属博客（小白教程）" data-images="http://azeril.me/img/fantasy.jpg" data-content="Build Your First Jekyll Blog

GitHub 以当前世界最大、也是最流行的代码托管平台和程序员的社交平台闻名遐迩。在代码托管平... | Microdust:Azeril's blog" data-url="http://azeril.me/blog/Build-Your-First-GitHub-Pages-Blog.html">
...
*   [<span class="fa-stack fa-lg"></span>](/feed.xml)
*   [<span class="fa-stack fa-lg"></span>](https://twitter.com/Azeril_Lapland)
*   [<span class="fa-stack fa-lg"></span>](https://github.com/Azeril)
*   [<span class="fa-stack fa-lg">_知_</span>](https://www.zhihu.com/people/Azeril)

© 2011~2016 Azeril ♪ Powered by Jekyll.
